...
* The tabular version (Google Sheets, CSV output (e.g., for Excel processing)) can be found here: https://ig-parser.newinstitutionalgrammar.org/

* The visual version (tree output format) can be found here: https://ig-parser.newinstitutionalgrammar.org/visual/
